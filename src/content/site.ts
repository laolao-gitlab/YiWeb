...
import type { BrandContent, DuoContent, RepertoireContent } from './schema'
...
export const siteNavigation: NavigationItem[] = [
  ...
  { id: 'repertoire', href: (lang) => `/${lang}/repertoire`, label: { en: 'Repertoire', de: 'Repertoire', 'zh-Hant': '曲目' } },
...
export const repertoireContent: RepertoireContent = data.repertoire
